...
if 1:
    run_desc = 'celeba'
    dataset = dict(h5_path='/Users/mac/Desktop/Theano_PG_GANs_Clean/datasets/celeba-128x128.h5', resolution=128, max_labels=0, mirror_augment=True)
